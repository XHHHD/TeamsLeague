...
{
    public static class CharDescriptions
    {
        ...
        public static string GetDescription(GameCharType type) => type switch
        {
            GameCharType.Aurelia => Aurelia,
            GameCharType.Ragnus => Ragnus,
            GameCharType.Ivy => Ivy,
            GameCharType.Cogsworth => Cogsworth,
            GameCharType.Elara => Elara,
            GameCharType.Thundar => Thundar,
            GameCharType.Morok => Morok,
            GameCharType.Lyra => Lyra,
            GameCharType.Grimclaw => Grimclaw,
            GameCharType.Nymphia => Nymphia,
            GameCharType.Ignis => Ignis,
            GameCharType.Vera => Vera,
            GameCharType.Zephyr => Zephyr,
            GameCharType.Solus => Solus,
            GameCharType.Grom => Grom,
            GameCharType.Vespera => Vespera,
            GameCharType.Zarael => Zarael,
            GameCharType.Tusk => Tusk,
            GameCharType.Lunara => Lunara,
            GameCharType.Hex => Hex,
            GameCharType.Dracor => Dracor,
            GameCharType.Arachna => Arachna,
            GameCharType.Zilon => Zilon,
            GameCharType.Lyth => Lyth,
