namespace TeamsLeague.DAL.Constants.Names
{
    public static class MemberNames
    {
        public static readonly List<string> Names = new()
        {
            "Abasid", "AbsolutelyWinner", "AccidentalGenius", "AcidGosling", "AdmiralTot", "AgentHercules", "AirportHobo", "AlleyFrog", "Alpha", "AlphaReturns", "Angel", "AngelsCreed", "ArsenicCoo", "AtomicBlastoid", "AutomaticSlicer", "Aspect", "Atilla", "Automatic", "Aero", "Albatross", "Arsenal", "Avenger", "Agrippa", "Amazing",
            ...
            "Vein", "Void", "Vulture", "Viper", "Vehiclon", "Volt", "VictorI",
